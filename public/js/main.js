	...
	class MainController {
		...
		constructor($http, $mdMedia, $mdDialog) {
         ...
         this.days = [{ dd: dd, mm: mm, yyyy: yyyy }, { dd: dd + 1, mm: mm, yyyy: yyyy }, { dd: dd + 2, mm: mm, yyyy: yyyy }, { dd: dd + 3, mm: mm, yyyy: yyyy },
            { dd: dd + 4, mm: mm, yyyy: yyyy }, { dd: dd + 5, mm: mm, yyyy: yyyy }, { dd: dd + 6, mm: mm, yyyy: yyyy } ];
			this.slots = [{ h: '9', m: '00' }, { h: '11', m: '00' }, { h: '13', m: '00' }, { h: '15', m: '00' }, { h: '17', m: '00' }, { h: '19', m: '00' }, { h: '21', m: '00' }];
		}
